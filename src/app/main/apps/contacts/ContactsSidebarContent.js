        ...
        <List className="pt-0 px-12">
          ...
          <Stack sx={{my: 2}}>
            ...
            <StyledListItem
              button
              component={NavLinkAdapter}
              to="/apps/contacts/active" // Cambia la ruta a /apps/contacts/active
              activeClassName="active"
            >
              <PersonIcon style={{color: 'green'}} />
              <ListItemText 
            ...
            <StyledListItem
              button
              component={NavLinkAdapter}
              to="/apps/contacts/inactive" // Cambia la ruta a /apps/contacts/inactive
              activeClassName="active"
            >
              <PersonIcon style={{color: 'orange'}} />
              <ListItemText 
          ...
          <Stack>
            ...
            <StyledListItem
              button
              component={NavLinkAdapter}
              to="/apps/contacts/admin" // Cambia la ruta a /apps/contacts/admin
              activeClassName="active"
            >
              <ManageAccountsIcon />
              <ListItemText 
            ...
            <StyledListItem
              button
              component={NavLinkAdapter}
              to="/apps/contacts/user" // Cambia la ruta a /apps/contacts/user
              activeClassName="active"
            >
              <PersonOutlineIcon />
              <ListItemText 
